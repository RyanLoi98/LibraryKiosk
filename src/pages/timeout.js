    ...
    <div>
      ...
      <div class="section-result">
        ...
        <div class="timeout-overlay">
          <h1 class="timeout-message-title">Are you still there?</h1>
          <p class="timeout-message">Tap anywhere to resume</p>
          <p class="timeout-message-exit">Returning to Main Screen in: 0:59</p>
        </div>
        {/*  */}
