...
// import css file
import ".//hungerGamesViewMap.css";
import HomeHeaderLoggedin from "../components/home-header-loggedin";

function hungerGameViewMap() {
    return (
        <div className="map-pages">
            <div className="hungerGamesViewMapHomeHeaderLoggedIn"> <HomeHeaderLoggedin /></div>

            <Tab.Container id="floor-map-indicator" defaultActiveKey="L3">
                <Row>
                        ...
                        <Tab.Content>
                            ...
                            <Tab.Pane eventKey="L3">
                                ...
                                <h3 className="instructions">
                                    The novel you are looking for is located in the back of level 3 near
                                    the washrooms in the teens sections.
                                </h3>
                            </Tab.Pane>
...
export default hungerGameViewMap;
